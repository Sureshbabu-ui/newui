...
import { EventConditionCreate, EventConditionListView, EventDetail } from '../../../../types/ApprovalWorkflow/eventCondition';
...
export interface CreateEventConditionState {
    eventCondition: EventConditionCreate;
...
const initialState: CreateEventConditionState = {
    eventCondition: {
...
const slice = createSlice({
    ...
    reducers: {
        ...
        updateField: (
            state,
            { payload: { name, value } }: PayloadAction<{ name: keyof CreateEventConditionState['eventCondition']; value: any }>
        ) => {
