...
import { PartAllocation, PartIndentDemandList, PartIndentDemandLogistics, PartIndentDemandLogisticsList, partIndentDemandList } from '../../../../../../../types/partindentdemand';
...
const slice = createSlice({
    name: 'partindentdemandlogisticsallocated',
    initialState,
    reducers: {
