...
{
    /// <inheritdoc />
    public partial class sp_0_31_alpha_8 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            string storedProcedureFolder = Path.Combine(Directory.GetCurrentDirectory(), "StoredProcedures\\release_0_31_alpha_8");
